...
def get_channel_circuit():
    """
    returns a 3-qubit QuantumCircuit implementing a random channel circuit with
    up to one phase-flip error.
    """
...
def get_decode_circuit():
    """
    returns a 3-qubit QuantumCircuit imlementing the decoding circuit for the 
    3-qubit phase-flip code.
    """
